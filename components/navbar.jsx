    ...
    >
      ...
      <div className={styles.mainNav}>
        ...
        <nav className={`${styles.links} ${menuOpen ? styles.linksOpen : ""}`}>
          ...
          <a href="/shop" className={isActive("/shop") ? styles.active : ""}>
            Shop
          </a>
          <a
            href="/categories"
          ...
          <a href="/deals" className={isActive("/deals") ? styles.active : ""}>
            Deals
          </a>
          <a
            href="/new-arrivals"
            className={isActive("/new-arrivals") ? styles.active : ""}
          >
            New arrivals
          </a>
          <a href="/pages" className={isActive("/pages") ? styles.active : ""}>
            Pages
          </a>
        </nav>
